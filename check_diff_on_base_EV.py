...
def git_update_buildroot_base():
	print "***************************************"
	print "Git clone buildroot on branch : N331_EV......"
	os.system("git clone ssh://yjin10@136.18.227.58:29418/buildroot buildroot_EV -b N331_EV")
...
#	os.system("git clone ssh://yjin10@136.18.227.58:29418/buildroot -b N331")
	...
	print "***************************************"
	print "Git clone buildroot on branch : N331_EV......"
	os.system("git clone ssh://yjin10@136.18.227.58:29418/buildroot base_EV  -b N331_EV")
	print "***************************************"

CURRENT_PATH=os.getcwd()
GIT_WORK_PATH=os.path.join(CURRENT_PATH,'buildroot_EV')
BASE_GIT_WORK_PATH=os.path.join(CURRENT_PATH,'base_EV')
PACKAGE_BASE_GIT="git clone ssh://yjin10@136.18.227.58:29418/"
package_list = ['n331_amapapi_service:',
		'n331_audio_manager:ev',
		'n331_carsteward:',
                'n331_entertainment:',
       	        'n331_hmi_centerstack:hmi_ev_model',
                'n331_hmi_cluster:Cluster_EV',
                'n331_hmi_swdl:',
                'n331_ipc:EV',
                'n331_ipod_service:',
                'n331_meter:EV',
...
if __name__ =="__main__":
	...
	if (len(sys.argv) == 3):
		...
		reset2version("buildroot_EV",sys.argv[1])
		reset2version("base_EV",sys.argv[2])		

		savedStdout = sys.stdout #保存标准输出流
		with open('diff_EV.log', 'w+') as file:
			os.system('date')	
			sys.stdout.flush()
