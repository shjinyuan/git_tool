...
#	os.system("git clone ssh://yjin10@136.18.227.58:29418/buildroot -b N331_SOP2_Candidate")
	...
	os.system("git clone ssh://yjin10@136.18.227.58:29418/buildroot buildroot_daily -b N331")
	print "***************************************"
...
#	os.system("git clone ssh://yjin10@136.18.227.58:29418/buildroot base  -b N331_SOP2_Candidate")
	print "Git clone buildroot on branch : N331"
	os.system("git clone ssh://yjin10@136.18.227.58:29418/buildroot base_daily  -b N331")
	print "***************************************"

CURRENT_PATH=os.getcwd()
GIT_WORK_PATH=os.path.join(CURRENT_PATH,'buildroot_daily')
BASE_GIT_WORK_PATH=os.path.join(CURRENT_PATH,'base_daily')
...
if __name__ =="__main__":
	...
	if (len(sys.argv) == 3):
		...
		reset2version("buildroot_daily",sys.argv[1])
		reset2version("base_daily",sys.argv[2])		
